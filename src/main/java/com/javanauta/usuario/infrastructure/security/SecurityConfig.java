    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/usuario").permitAll()//Permite acesso ao endopoint sem login
                        .requestMatchers(HttpMethod.POST, "/usuario/login").permitAll()//Permite acesso ao enpoint Post
                        .requestMatchers("/usuario/**").authenticated()//Requer autenticação para qualquer endpoint
